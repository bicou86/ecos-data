...
TARGETS = [
    "Atrophie musculaire gauche et cicatrices chirurgicales.jpg",
    "Glide test.jpg",
    "Palpation de la surface articulaire fémoro-patellaire médiale et latérale.jpg",
    "Palpation des facettes patellaires postérieures.jpg",
    "Palpation des ménisques.jpg",
    "Pivot shift test.jpg",
    "Signe du glaçon.jpg",
    "Test d'avalement de la tubérosité tibale antérieure.jpg",
    "Test de Lachmann.jpg",
    "Test de Rabot.jpg",
    "Test de Zholen.jpg",
    "Tiroir antérieur et postérieur.jpg",
]
