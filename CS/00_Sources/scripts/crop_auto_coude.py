...
# Photos cliniques 4928×3264 ou 4032×3024 — toutes prises dans la même salle
TARGETS = [
    "Hook test.jpg",
    "Mobilisations actives de flexion et d'extension.jpg",
    "Mobilisations actives de pronation et supination.jpg",
    "Palpation de l'articulation du coude.jpg",
    "Palpation du nerf ulnaire.jpg",
    "Test d'instabilité rotatoire postéro-latérale du radius.jpg",
    "Test de Cozen inversé.jpg",
    "Test de Cozen.jpg",
    "Test de Maudsley.jpg",
    "Test de Mill inversé.jpg",
    "Test de Mill.jpg",
    "Test de laxité des ligaments collatéraux.jpg",
]
...
def find_content_bounds(img: Image.Image, low: float, high: float, step: int):
    ...
    BAND = 8
    RANGE_THRESHOLD = 70
    SAT_THRESHOLD = 100  # pixel coloré (flèche d'annotation)
